...
class Clean_File_Name:
    ...
    def clear_name(self):
        ...
        file_endswith = ['.jpg', '.png', '.mp4', '.gif']

        for country in self.file_path_list:
            plik_jpg_istnieje = any(
                plik.endswith(rozszerzenie) for plik in self.file_path_list for rozszerzenie in ['.jpg', '.png', '.mp4', '.gif'])
            if plik_jpg_istnieje == True and country[-4::] in file_endswith:
                ...
                elif 'BEN' in country or 'BEF' in country:
